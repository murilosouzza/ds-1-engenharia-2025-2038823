...
A ferramenta também possui uso de dtas, lembretes e notificações para os cartôes, além de que, também é possível atribuir determinada tarefa para uma ou mais pessoas do time, também tem "Checklists" que funciona para detalhar os passos de uma tarefa/sequência de ações que precisam ser marcadas como concluídas. 
